...
const storeProfileSchemma = z.object({
  name: z.string().min(1),
  description: z.string().nullable(),
})

type StoreProfileSchemma = z.infer<typeof storeProfileSchemma>
...
export function StoreProfileDialog() {
  ...
  } = useForm<StoreProfileSchemma>({
    resolver: zodResolver(storeProfileSchemma),
    values: {
  ...
  async function handleUpdateProfile(data: StoreProfileSchemma) {
    try {
